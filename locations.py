...
class locations(minqlx.Plugin):
    def __init__(self):
        self.set_cvar_once("qlx_locationCommandPermissionRequired", "0")
    ...
    def cmd_location(self, player, msg, channel):
        ...
        channel.reply("{}^7's Country Code: {}, Country Name: {}, Region Code: {}, Region Name: {}, City: {}".format(player_name, ipDataParsed['country_code'], ipDataParsed['country_name'], ipDataParsed['region_code'], ipDataParsed['region_name'], ipDataParsed['city']))
