...
class access(minqlx.Plugin):
    def __init__(self):
        ...
        self.add_command("getmyaccess", self.cmd_get_my_access, priority=minqlx.PRI_LOW)
    ...
    def handle_player_loaded(self, player):
        user_access_date = self.get_access_deadline(player)
    ...
    def cmd_get_my_access(self, player, msg, channel):
        ...
        channel.reply("^6{}^7, you have access to Cells servers until: ^6{}".format(player.name, user_access_date))
